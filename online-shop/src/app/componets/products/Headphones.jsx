...
export const Headphones =() => {
    ...
    return(
        <div className='mt-4 flex  justify-center  flex-wrap gap-3   px-[10%]  xl:px-[20%] '>
            {
                headphones.map(({name,id,price,img})=>{
                    return(
                        <div key={id} className='group  rounded-xl py-4 
                        h-80
                        hover:shadow-2xl hover:scale-105 border border-slate-300 hover:bg-zinc-100 duration-300 '>
                            <img  
                            src={img}
